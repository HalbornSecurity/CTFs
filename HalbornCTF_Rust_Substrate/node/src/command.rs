...
use malborn_chain_executor::Executor;
use malborn_chain_primitives::Block;
use sc_cli::{ChainSpec, Result, Role, RuntimeVersion, SubstrateCli};
use sc_service::PartialComponents;

impl SubstrateCli for Cli {
    fn impl_name() -> String {
        "Malborn Chain Node".into()
    }
    ...
    fn support_url() -> String {
        "https://github.com/Malborn/chain/issues".into()
    }
