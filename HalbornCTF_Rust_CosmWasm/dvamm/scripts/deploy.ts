...
async function main() {
    ...
    let tokenA = await instantiateContract(terra, wallet, network.tokenCodeID, TOKEN_INFO);
    ...
    let tokenB = await instantiateContract(terra, wallet, network.tokenCodeID, TOKEN_INFO);
    console.log('Token B Address: ' + tokenB);

    console.log(`\nADMIN wallet: ${wallet.key.accAddress}`)
